...
/**
 * Copy in site-data.ts is plain text, so it marks a price with a `{price}`
 * token rather than JSX. This swaps each token for the live, region-gated
 * component. Splitting on a capturing group keeps the delimiter, so the
 * odd-indexed pieces are exactly the tokens.
 */
